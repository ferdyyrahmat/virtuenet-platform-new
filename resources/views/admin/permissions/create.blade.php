@extends('layouts.vertical', ['title' => 'Create Role & Permissions'])
...
<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Create Role & Permissions</h4>
        </div>
    ...
    <form action="{{ route('admin.permissions.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required placeholder="e.g. Administrator, Editor, Supervisor">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="description" class="form-label">Description</label>
                                <input type="text" class="form-control" id="description" name="description" placeholder="Short description of the role's purpose">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <x-permission-assignment :categories="$permissionCategories" />
